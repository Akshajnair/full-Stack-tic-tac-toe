...
export class Game extends Component {
    render() {
        return (
            <div>
                    <section class="u-align-center u-clearfix u-custom-color-2 u-section-2" id="sec-2bf1">
      <div class="u-clearfix u-sheet u-sheet-1">
        <Link to='/'><a class="u-border-3 u-border-active-palette-2-dark-1 u-border-custom-color-2 u-border-hover-custom-color-1 u-btn u-button-style u-none u-text-custom-color-1 u-text-hover-custom-color-1 u-btn-1">BACK</a></Link>
        ...
        <div class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-gallery u-layout-grid u-show-text-on-hover u-gallery-1">
